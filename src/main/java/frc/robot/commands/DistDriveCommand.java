...
public class DistDriveCommand extends Command {
    ...
    public void initialize() {
        ...
        SwerveModuleState[] defaultState = new SwerveModuleState[4];
        defaultState[0] = new SwerveModuleState(0, Rotation2d.k180deg);
        defaultState[1] = new SwerveModuleState(0, Rotation2d.k180deg);
        defaultState[2] = new SwerveModuleState(0, Rotation2d.k180deg);
        defaultState[3] = new SwerveModuleState(0, Rotation2d.k180deg);
