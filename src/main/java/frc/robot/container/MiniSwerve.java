...
public class MiniSwerve extends RobotContainer{
    public MiniSwerve(){
        ...
        SwerveModule frontLeftCorner = new SDSSwerveModule(driveMotor, pivotMotor, swerveModuleEncoder,Inches.of(4),Inches.of(4), pivotFeedback, driveFeedback,Degrees.of(0)
        , true);
        SwerveModule frontRightCorner = new SDSSwerveModule(driveMotor2, pivotMotor2, swerveModuleEncoder2,Inches.of(4),Inches.of(-4), pivotFeedback, driveFeedback,Degrees.of(0),true);
        SwerveModule backLeftCorner = new SDSSwerveModule(driveMotor3, pivotMotor3, swerveModuleEncoder3,Inches.of(-4),Inches.of(4), pivotFeedback, driveFeedback,Degrees.of(0),true);
        SwerveModule backRightCorner = new SDSSwerveModule(driveMotor4, pivotMotor4, swerveModuleEncoder4,Inches.of(-4), Inches.of(-4),  pivotFeedback, driveFeedback,Degrees.of(0), true);
