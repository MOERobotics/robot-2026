    ...
    public SDSSwerveDrive(Pigeon2 robotGyro, SwerveModuleSubsystem... swerveModules) {
       ...
       // simGyro = robotGyro.getSimState();
        ...
        AutoBuilder.configure(
                ...
                (speeds, feedforwards) -> robotDrive(speeds), // Method that will drive the robot given ROBOT RELATIVE ChassisSpeeds. Also optionally outputs individual module feedforwards
